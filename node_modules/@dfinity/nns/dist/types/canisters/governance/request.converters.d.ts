...
import type { ListProposalInfo, ManageNeuronCommandRequest as RawCommand, ListNeurons as RawListNeurons, ManageNeuronRequest as RawManageNeuron, Operation as RawOperation } from "../../../candid/governance";
import type { NeuronVisibility, Vote } from "../../enums/governance.enums";
import type { E8s, NeuronId } from "../../types/common";
import type { ClaimOrRefreshNeuronRequest, DisburseToNeuronRequest, FollowRequest, ListProposalsRequest, MakeProposalRequest, ManageNeuronRequest, ProposalId } from "../../types/governance_converters";
export declare const fromListNeurons: ({ neuronIds, includeEmptyNeurons, includePublicNeurons, }: {
    neuronIds?: NeuronId[];
